    ...
    <PageLayout>
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-gray-900 to-black min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-20 right-20 w-24 h-24 border border-cyan-400/20 rounded-lg rotate-45 animate-pulse" style={{ animationDelay: '1.5s' }}></div>
          <div className="absolute top-1/2 right-10 w-16 h-16 border border-purple-400/20 rounded-full animate-pulse" style={{ animationDelay: '3s' }}></div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10 py-20">
          ...
          <div className="inline-flex items-center px-6 py-3 bg-white/10 backdrop-blur-md rounded-full border border-white/20 mb-12 group hover:bg-white/15 transition-all duration-500 hover:scale-105">
            <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-purple-400 rounded-full mr-3 animate-pulse"></div>
            <Zap className="w-4 h-4 mr-2 text-blue-300 group-hover:text-blue-200 transition-colors" />
            <span className="text-white/90 font-medium group-hover:text-white transition-colors">AI-Powered Learning Platform</span>
            <div className="w-2 h-2 bg-gradient-to-r from-purple-400 to-cyan-400 rounded-full ml-3 animate-pulse" style={{ animationDelay: '1s' }}></div>
          </div>

          {/* Enhanced Hero Title with Better Typography */}
          <h1 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-white mb-8 leading-tight tracking-tight">
            <span className="block mb-4">Build Skills That</span>
            <span className="block bg-gradient-to-r from-blue-400 via-cyan-300 to-purple-400 bg-clip-text text-transparent animate-gradient relative">
              Set You Apart
              {/* Subtle underline effect */}
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-32 h-1 bg-gradient-to-r from-transparent via-cyan-400/50 to-transparent rounded-full"></div>
            </span>
          </h1>
          
          {/* Enhanced Subtitle */}
          <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-16 max-w-4xl mx-auto leading-relaxed font-light">
            Learn practical frameworks in 
            <span className="text-white font-medium bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent"> Agile, leadership, and mental fitness </span>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center max-w-2xl mx-auto mb-20">
            ...
            <Button 
              size="lg" 
              className="w-full sm:w-auto text-lg px-10 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white hover:from-blue-700 hover:to-purple-700 transition-all duration-300 font-semibold rounded-xl shadow-2xl hover:shadow-blue-500/25 hover:scale-105 border-0 group" 
              asChild
            >
              <Link href="/synergize">
                <span className="flex items-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              ...
              { number: "50+", label: "Courses", icon: <BookOpen className="w-5 h-5" /> }
            ].map((stat, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-6 hover:bg-white/10 transition-all duration-300 hover:scale-105 group">
                <div className="flex items-center justify-center mb-3 text-blue-400 group-hover:text-cyan-400 transition-colors">
                  {stat.icon}
                </div>
                <div className="text-2xl md:text-3xl font-bold text-white mb-1 group-hover:scale-110 transition-transform">{stat.number}</div>
                <div className="text-sm text-gray-400 uppercase tracking-wide font-medium">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
