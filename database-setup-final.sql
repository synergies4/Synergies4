-- Final Database Setup for Synergies4AI
-- Removes problematic foreign key constraints to avoid type mismatches

-- Create meeting_transcripts table first
...
-- Meeting Bots Table for tracking recording sessions (WITHOUT foreign key constraint)
CREATE TABLE IF NOT EXISTS meeting_bots (
  ...
  -- References (removed foreign key constraint to avoid type issues)
  transcript_id INTEGER, -- Simple reference without constraint
